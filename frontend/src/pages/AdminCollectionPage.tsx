...
export function AdminCollectionPage() {
    ...
    const handleCreateCollection = async () => {
        ...
        if (isNaN(totalAmountValue) || totalAmountValue <= 0) {
            setMessage({
                type: "error",
                text: "Введите корректное количество подарков (положительное число)",
            });
            return;
        }
        ...
        try {
            ...
            if (response.success && response.responseObject) {
                ...
                setMessage({
                    type: "error",
                    text: response.message || "Ошибка при создании коллекции",
                });
            }
        } catch (error) {
            setMessage({
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Заполните все обязательные поля для создания новой
                            коллекции
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground">
                                Будет создано указанное количество подарков с
                                одинаковым эмодзи
                            </p>
                        </div>
